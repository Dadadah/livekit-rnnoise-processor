...
async function createRNNWasmModule(moduleArg = {}) {
    ...
    Module['_rnnoise_init'] = makeInvalidEarlyAccess('_rnnoise_init');
    Module['_rnnoise_create'] = makeInvalidEarlyAccess('_rnnoise_create');
    Module['_rnnoise_destroy'] = makeInvalidEarlyAccess('_rnnoise_destroy');
    Module['_rnnoise_process_frame'] = makeInvalidEarlyAccess('_rnnoise_process_frame');
    ...
    function assignWasmExports(wasmExports) {
        ...
        Module['_rnnoise_init'] = createExportWrapper('rnnoise_init', 2);
        Module['_rnnoise_create'] = createExportWrapper('rnnoise_create', 1);
        Module['_rnnoise_destroy'] = createExportWrapper('rnnoise_destroy', 1);
        Module['_rnnoise_process_frame'] = createExportWrapper('rnnoise_process_frame', 3);
...
class MonoResampler {
    ...
    carryOut = 0;
    outBuffer;
    constructor(sourceSampleRate, targetSampleRate, bufferSize) {
...
class DenoiserWorklet extends AudioWorkletProcessor {
    ...
    _inputBuffer = [];
    _outputBuffer = [];
    _frameBuffer = new Float32Array(RNNOISE_SAMPLE_LENGTH);
    _destroyed = false;
    _debugLogs = false;
    _vadLogs = false;
    _shouldDenoise = true;
