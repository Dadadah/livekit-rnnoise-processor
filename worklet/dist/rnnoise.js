...
async function createRNNWasmModule(moduleArg = {}) {
  var moduleRtn;
...
function findWasmBinary() {
  ...
  if (Module['locateFile']) {
    return locateFile('rnnoise.wasm');
  }

  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL('rnnoise.wasm', import.meta.url).href;
...
var _rnnoise_init = Module['_rnnoise_init'] = makeInvalidEarlyAccess('_rnnoise_init');
var _rnnoise_create = Module['_rnnoise_create'] = makeInvalidEarlyAccess('_rnnoise_create');
var _rnnoise_destroy = Module['_rnnoise_destroy'] = makeInvalidEarlyAccess('_rnnoise_destroy');
var _rnnoise_process_frame = Module['_rnnoise_process_frame'] = makeInvalidEarlyAccess('_rnnoise_process_frame');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['rnnoise_init'] != 'undefined', 'missing Wasm export: rnnoise_init');
  assert(typeof wasmExports['rnnoise_create'] != 'undefined', 'missing Wasm export: rnnoise_create');
  assert(typeof wasmExports['rnnoise_destroy'] != 'undefined', 'missing Wasm export: rnnoise_destroy');
  assert(typeof wasmExports['rnnoise_process_frame'] != 'undefined', 'missing Wasm export: rnnoise_process_frame');
  ...
  _rnnoise_init = Module['_rnnoise_init'] = createExportWrapper('rnnoise_init', 2);
  _rnnoise_create = Module['_rnnoise_create'] = createExportWrapper('rnnoise_create', 1);
  _rnnoise_destroy = Module['_rnnoise_destroy'] = createExportWrapper('rnnoise_destroy', 1);
  _rnnoise_process_frame = Module['_rnnoise_process_frame'] = createExportWrapper('rnnoise_process_frame', 3);
